...
- **GitHub**: you can choose to store everything in a GitHub repo. There is no need for manual or periodic commits: once you've changee a doc, the app immediately initiates a sync and uploads to GitHub. This can be used on mobile devices too, because the app uses the HTTP api to sync with GitHub.
